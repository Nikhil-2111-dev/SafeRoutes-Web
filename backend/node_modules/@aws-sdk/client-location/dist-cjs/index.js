...
class LocationServiceException extends ServiceException {
    constructor(options) {
        super(options);
...
var JobActionOptions$ = [3, n0, _JAO,
    0,
    [_VA],
...
var JobInputOptions$ = [3, n0, _JIO,
    0,
    [_Lo, _F],
    [0, 0], 2
];
var JobOutputOptions$ = [3, n0, _JOO,
    0,
    [_F, _Lo],
    [0, 0], 2
];
var JobsFilter$ = [3, n0, _JF,
    0,
    [_JS],
    [0]
];
...
var ListJobsResponseEntry$ = [3, n0, _LJRE,
    0,
...
var ValidateAddressActionOptions$ = [3, n0, _VAAO,
    0,
    [_AFd],
    [64 | 0]
];
...
class LocationClient extends Client {
    config;
...
const command = makeBuilder(commonParams, "LocationService", "LocationClient", getEndpointPlugin);
const _ep0 = {};
const _mw0 = (Command, cs, config, o) => [];

class AssociateTrackerConsumerCommand extends command(_ep0, _mw0, "AssociateTrackerConsumer", AssociateTrackerConsumer$) {
}

class BatchDeleteDevicePositionHistoryCommand extends command(_ep0, _mw0, "BatchDeleteDevicePositionHistory", BatchDeleteDevicePositionHistory$) {
}

class BatchDeleteGeofenceCommand extends command(_ep0, _mw0, "BatchDeleteGeofence", BatchDeleteGeofence$) {
}

class BatchEvaluateGeofencesCommand extends command(_ep0, _mw0, "BatchEvaluateGeofences", BatchEvaluateGeofences$) {
}

class BatchGetDevicePositionCommand extends command(_ep0, _mw0, "BatchGetDevicePosition", BatchGetDevicePosition$) {
}

class BatchPutGeofenceCommand extends command(_ep0, _mw0, "BatchPutGeofence", BatchPutGeofence$) {
}

class BatchUpdateDevicePositionCommand extends command(_ep0, _mw0, "BatchUpdateDevicePosition", BatchUpdateDevicePosition$) {
}

class CalculateRouteCommand extends command(_ep0, _mw0, "CalculateRoute", CalculateRoute$) {
}
...
class CreateGeofenceCollectionCommand extends command(_ep0, _mw0, "CreateGeofenceCollection", CreateGeofenceCollection$) {
}

class CreateKeyCommand extends command(_ep0, _mw0, "CreateKey", CreateKey$) {
}

class CreateMapCommand extends command(_ep0, _mw0, "CreateMap", CreateMap$) {
}

class CreatePlaceIndexCommand extends command(_ep0, _mw0, "CreatePlaceIndex", CreatePlaceIndex$) {
}

class CreateRouteCalculatorCommand extends command(_ep0, _mw0, "CreateRouteCalculator", CreateRouteCalculator$) {
}

class CreateTrackerCommand extends command(_ep0, _mw0, "CreateTracker", CreateTracker$) {
}

class DeleteGeofenceCollectionCommand extends command(_ep0, _mw0, "DeleteGeofenceCollection", DeleteGeofenceCollection$) {
}

class DeleteKeyCommand extends command(_ep0, _mw0, "DeleteKey", DeleteKey$) {
}

class DeleteMapCommand extends command(_ep0, _mw0, "DeleteMap", DeleteMap$) {
}

class DeletePlaceIndexCommand extends command(_ep0, _mw0, "DeletePlaceIndex", DeletePlaceIndex$) {
}

class DeleteRouteCalculatorCommand extends command(_ep0, _mw0, "DeleteRouteCalculator", DeleteRouteCalculator$) {
}

class DeleteTrackerCommand extends command(_ep0, _mw0, "DeleteTracker", DeleteTracker$) {
}

class DescribeGeofenceCollectionCommand extends command(_ep0, _mw0, "DescribeGeofenceCollection", DescribeGeofenceCollection$) {
}

class DescribeKeyCommand extends command(_ep0, _mw0, "DescribeKey", DescribeKey$) {
}

class DescribeMapCommand extends command(_ep0, _mw0, "DescribeMap", DescribeMap$) {
}

class DescribePlaceIndexCommand extends command(_ep0, _mw0, "DescribePlaceIndex", DescribePlaceIndex$) {
}

class DescribeRouteCalculatorCommand extends command(_ep0, _mw0, "DescribeRouteCalculator", DescribeRouteCalculator$) {
}

class DescribeTrackerCommand extends command(_ep0, _mw0, "DescribeTracker", DescribeTracker$) {
}

class DisassociateTrackerConsumerCommand extends command(_ep0, _mw0, "DisassociateTrackerConsumer", DisassociateTrackerConsumer$) {
}

class ForecastGeofenceEventsCommand extends command(_ep0, _mw0, "ForecastGeofenceEvents", ForecastGeofenceEvents$) {
}

class GetDevicePositionCommand extends command(_ep0, _mw0, "GetDevicePosition", GetDevicePosition$) {
}

class GetDevicePositionHistoryCommand extends command(_ep0, _mw0, "GetDevicePositionHistory", GetDevicePositionHistory$) {
}

class GetGeofenceCommand extends command(_ep0, _mw0, "GetGeofence", GetGeofence$) {
}

class GetJobCommand extends command(_ep0, _mw0, "GetJob", GetJob$) {
}

class GetMapGlyphsCommand extends command(_ep0, _mw0, "GetMapGlyphs", GetMapGlyphs$) {
}

class GetMapSpritesCommand extends command(_ep0, _mw0, "GetMapSprites", GetMapSprites$) {
}

class GetMapStyleDescriptorCommand extends command(_ep0, _mw0, "GetMapStyleDescriptor", GetMapStyleDescriptor$) {
}

class GetMapTileCommand extends command(_ep0, _mw0, "GetMapTile", GetMapTile$) {
}

class GetPlaceCommand extends command(_ep0, _mw0, "GetPlace", GetPlace$) {
}

class ListDevicePositionsCommand extends command(_ep0, _mw0, "ListDevicePositions", ListDevicePositions$) {
}

class ListGeofenceCollectionsCommand extends command(_ep0, _mw0, "ListGeofenceCollections", ListGeofenceCollections$) {
}

class ListGeofencesCommand extends command(_ep0, _mw0, "ListGeofences", ListGeofences$) {
}
...
class ListMapsCommand extends command(_ep0, _mw0, "ListMaps", ListMaps$) {
}

class ListPlaceIndexesCommand extends command(_ep0, _mw0, "ListPlaceIndexes", ListPlaceIndexes$) {
}

class ListRouteCalculatorsCommand extends command(_ep0, _mw0, "ListRouteCalculators", ListRouteCalculators$) {
}

class ListTagsForResourceCommand extends command(_ep0, _mw0, "ListTagsForResource", ListTagsForResource$) {
}

class ListTrackerConsumersCommand extends command(_ep0, _mw0, "ListTrackerConsumers", ListTrackerConsumers$) {
}

class ListTrackersCommand extends command(_ep0, _mw0, "ListTrackers", ListTrackers$) {
}

class PutGeofenceCommand extends command(_ep0, _mw0, "PutGeofence", PutGeofence$) {
}

class SearchPlaceIndexForPositionCommand extends command(_ep0, _mw0, "SearchPlaceIndexForPosition", SearchPlaceIndexForPosition$) {
}

class SearchPlaceIndexForSuggestionsCommand extends command(_ep0, _mw0, "SearchPlaceIndexForSuggestions", SearchPlaceIndexForSuggestions$) {
}

class SearchPlaceIndexForTextCommand extends command(_ep0, _mw0, "SearchPlaceIndexForText", SearchPlaceIndexForText$) {
}
...
class UpdateGeofenceCollectionCommand extends command(_ep0, _mw0, "UpdateGeofenceCollection", UpdateGeofenceCollection$) {
}

class UpdateKeyCommand extends command(_ep0, _mw0, "UpdateKey", UpdateKey$) {
}

class UpdateMapCommand extends command(_ep0, _mw0, "UpdateMap", UpdateMap$) {
}

class UpdatePlaceIndexCommand extends command(_ep0, _mw0, "UpdatePlaceIndex", UpdatePlaceIndex$) {
}

class UpdateRouteCalculatorCommand extends command(_ep0, _mw0, "UpdateRouteCalculator", UpdateRouteCalculator$) {
}

class UpdateTrackerCommand extends command(_ep0, _mw0, "UpdateTracker", UpdateTracker$) {
}

class VerifyDevicePositionCommand extends command(_ep0, _mw0, "VerifyDevicePosition", VerifyDevicePosition$) {
}
...
const paginateListJobs = createPaginator(LocationClient, ListJobsCommand, "NextToken", "NextToken", "MaxResults");
...
exports.ListJobsResponseEntry$ = ListJobsResponseEntry$;
...
exports.ValidateAddressActionOptions$ = ValidateAddressActionOptions$;
