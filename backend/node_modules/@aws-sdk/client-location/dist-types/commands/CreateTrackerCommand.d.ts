...
declare const CreateTrackerCommand_base: {
    new (input: CreateTrackerCommandInput): import("@smithy/core/client").CommandImpl<CreateTrackerCommandInput, CreateTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrackerCommandInput): import("@smithy/core/client").CommandImpl<CreateTrackerCommandInput, CreateTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
