...
declare const CreatePlaceIndexCommand_base: {
    new (input: CreatePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<CreatePlaceIndexCommandInput, CreatePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<CreatePlaceIndexCommandInput, CreatePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
