...
declare const DeleteRouteCalculatorCommand_base: {
    new (input: DeleteRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCalculatorCommandInput, DeleteRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCalculatorCommandInput, DeleteRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
