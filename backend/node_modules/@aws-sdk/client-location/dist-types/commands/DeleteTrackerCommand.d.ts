...
declare const DeleteTrackerCommand_base: {
    new (input: DeleteTrackerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrackerCommandInput, DeleteTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrackerCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrackerCommandInput, DeleteTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
