...
declare const UpdateKeyCommand_base: {
    new (input: UpdateKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateKeyCommandInput, UpdateKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateKeyCommandInput, UpdateKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
