...
declare const DescribePlaceIndexCommand_base: {
    new (input: DescribePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<DescribePlaceIndexCommandInput, DescribePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<DescribePlaceIndexCommandInput, DescribePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
