...
declare const BatchUpdateDevicePositionCommand_base: {
    new (input: BatchUpdateDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<BatchUpdateDevicePositionCommandInput, BatchUpdateDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchUpdateDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<BatchUpdateDevicePositionCommandInput, BatchUpdateDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
