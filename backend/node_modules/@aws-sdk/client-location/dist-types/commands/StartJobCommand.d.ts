...
declare const StartJobCommand_base: {
    new (input: StartJobCommandInput): import("@smithy/core/client").CommandImpl<StartJobCommandInput, StartJobCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartJobCommandInput): import("@smithy/core/client").CommandImpl<StartJobCommandInput, StartJobCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
