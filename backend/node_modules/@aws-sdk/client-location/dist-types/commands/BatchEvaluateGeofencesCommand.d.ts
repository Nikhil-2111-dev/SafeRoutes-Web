...
declare const BatchEvaluateGeofencesCommand_base: {
    new (input: BatchEvaluateGeofencesCommandInput): import("@smithy/core/client").CommandImpl<BatchEvaluateGeofencesCommandInput, BatchEvaluateGeofencesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchEvaluateGeofencesCommandInput): import("@smithy/core/client").CommandImpl<BatchEvaluateGeofencesCommandInput, BatchEvaluateGeofencesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
