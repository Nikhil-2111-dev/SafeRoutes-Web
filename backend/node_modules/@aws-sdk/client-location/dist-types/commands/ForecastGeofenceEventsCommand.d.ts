...
declare const ForecastGeofenceEventsCommand_base: {
    new (input: ForecastGeofenceEventsCommandInput): import("@smithy/core/client").CommandImpl<ForecastGeofenceEventsCommandInput, ForecastGeofenceEventsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ForecastGeofenceEventsCommandInput): import("@smithy/core/client").CommandImpl<ForecastGeofenceEventsCommandInput, ForecastGeofenceEventsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
