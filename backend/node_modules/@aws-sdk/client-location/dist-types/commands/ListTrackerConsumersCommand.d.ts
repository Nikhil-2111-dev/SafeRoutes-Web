...
declare const ListTrackerConsumersCommand_base: {
    new (input: ListTrackerConsumersCommandInput): import("@smithy/core/client").CommandImpl<ListTrackerConsumersCommandInput, ListTrackerConsumersCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTrackerConsumersCommandInput): import("@smithy/core/client").CommandImpl<ListTrackerConsumersCommandInput, ListTrackerConsumersCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
