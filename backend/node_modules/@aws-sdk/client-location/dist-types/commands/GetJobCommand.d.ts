...
declare const GetJobCommand_base: {
    new (input: GetJobCommandInput): import("@smithy/core/client").CommandImpl<GetJobCommandInput, GetJobCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetJobCommandInput): import("@smithy/core/client").CommandImpl<GetJobCommandInput, GetJobCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
