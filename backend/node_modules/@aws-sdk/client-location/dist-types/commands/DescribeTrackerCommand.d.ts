...
declare const DescribeTrackerCommand_base: {
    new (input: DescribeTrackerCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrackerCommandInput, DescribeTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTrackerCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrackerCommandInput, DescribeTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
