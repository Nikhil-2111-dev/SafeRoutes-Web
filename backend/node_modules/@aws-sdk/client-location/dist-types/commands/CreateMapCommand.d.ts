...
declare const CreateMapCommand_base: {
    new (input: CreateMapCommandInput): import("@smithy/core/client").CommandImpl<CreateMapCommandInput, CreateMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMapCommandInput): import("@smithy/core/client").CommandImpl<CreateMapCommandInput, CreateMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
