...
declare const CreateKeyCommand_base: {
    new (input: CreateKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyCommandInput, CreateKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateKeyCommandInput, CreateKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
