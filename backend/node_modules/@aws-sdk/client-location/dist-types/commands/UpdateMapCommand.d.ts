...
declare const UpdateMapCommand_base: {
    new (input: UpdateMapCommandInput): import("@smithy/core/client").CommandImpl<UpdateMapCommandInput, UpdateMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMapCommandInput): import("@smithy/core/client").CommandImpl<UpdateMapCommandInput, UpdateMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
