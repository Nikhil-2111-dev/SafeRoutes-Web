...
declare const GetMapGlyphsCommand_base: {
    new (input: GetMapGlyphsCommandInput): import("@smithy/core/client").CommandImpl<GetMapGlyphsCommandInput, GetMapGlyphsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMapGlyphsCommandInput): import("@smithy/core/client").CommandImpl<GetMapGlyphsCommandInput, GetMapGlyphsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
