...
declare const SearchPlaceIndexForSuggestionsCommand_base: {
    new (input: SearchPlaceIndexForSuggestionsCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForSuggestionsCommandInput, SearchPlaceIndexForSuggestionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchPlaceIndexForSuggestionsCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForSuggestionsCommandInput, SearchPlaceIndexForSuggestionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
