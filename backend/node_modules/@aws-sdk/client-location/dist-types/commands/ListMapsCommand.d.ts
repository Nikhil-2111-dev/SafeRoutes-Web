...
declare const ListMapsCommand_base: {
    new (input: ListMapsCommandInput): import("@smithy/core/client").CommandImpl<ListMapsCommandInput, ListMapsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMapsCommandInput]): import("@smithy/core/client").CommandImpl<ListMapsCommandInput, ListMapsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
