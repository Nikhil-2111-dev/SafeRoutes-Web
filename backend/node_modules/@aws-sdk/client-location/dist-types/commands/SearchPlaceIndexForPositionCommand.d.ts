...
declare const SearchPlaceIndexForPositionCommand_base: {
    new (input: SearchPlaceIndexForPositionCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForPositionCommandInput, SearchPlaceIndexForPositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchPlaceIndexForPositionCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForPositionCommandInput, SearchPlaceIndexForPositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
