...
declare const ListDevicePositionsCommand_base: {
    new (input: ListDevicePositionsCommandInput): import("@smithy/core/client").CommandImpl<ListDevicePositionsCommandInput, ListDevicePositionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDevicePositionsCommandInput): import("@smithy/core/client").CommandImpl<ListDevicePositionsCommandInput, ListDevicePositionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
