...
declare const ListTrackersCommand_base: {
    new (input: ListTrackersCommandInput): import("@smithy/core/client").CommandImpl<ListTrackersCommandInput, ListTrackersCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListTrackersCommandInput]): import("@smithy/core/client").CommandImpl<ListTrackersCommandInput, ListTrackersCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
