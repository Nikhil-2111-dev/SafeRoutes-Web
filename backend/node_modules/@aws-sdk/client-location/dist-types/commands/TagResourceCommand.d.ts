...
declare const TagResourceCommand_base: {
    new (input: TagResourceCommandInput): import("@smithy/core/client").CommandImpl<TagResourceCommandInput, TagResourceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagResourceCommandInput): import("@smithy/core/client").CommandImpl<TagResourceCommandInput, TagResourceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
