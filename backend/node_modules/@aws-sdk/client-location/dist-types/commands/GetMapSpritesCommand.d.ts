...
declare const GetMapSpritesCommand_base: {
    new (input: GetMapSpritesCommandInput): import("@smithy/core/client").CommandImpl<GetMapSpritesCommandInput, GetMapSpritesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMapSpritesCommandInput): import("@smithy/core/client").CommandImpl<GetMapSpritesCommandInput, GetMapSpritesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
