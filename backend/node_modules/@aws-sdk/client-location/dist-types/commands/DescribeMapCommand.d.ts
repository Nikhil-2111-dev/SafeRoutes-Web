...
declare const DescribeMapCommand_base: {
    new (input: DescribeMapCommandInput): import("@smithy/core/client").CommandImpl<DescribeMapCommandInput, DescribeMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMapCommandInput): import("@smithy/core/client").CommandImpl<DescribeMapCommandInput, DescribeMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
