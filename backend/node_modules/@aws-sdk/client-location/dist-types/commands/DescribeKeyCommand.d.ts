...
declare const DescribeKeyCommand_base: {
    new (input: DescribeKeyCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyCommandInput, DescribeKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeKeyCommandInput): import("@smithy/core/client").CommandImpl<DescribeKeyCommandInput, DescribeKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
