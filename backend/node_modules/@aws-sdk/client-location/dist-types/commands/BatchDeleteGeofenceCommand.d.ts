...
declare const BatchDeleteGeofenceCommand_base: {
    new (input: BatchDeleteGeofenceCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteGeofenceCommandInput, BatchDeleteGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDeleteGeofenceCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteGeofenceCommandInput, BatchDeleteGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
