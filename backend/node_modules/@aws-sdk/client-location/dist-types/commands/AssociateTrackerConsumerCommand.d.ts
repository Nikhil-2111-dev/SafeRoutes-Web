...
declare const AssociateTrackerConsumerCommand_base: {
    new (input: AssociateTrackerConsumerCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrackerConsumerCommandInput, AssociateTrackerConsumerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTrackerConsumerCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrackerConsumerCommandInput, AssociateTrackerConsumerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
