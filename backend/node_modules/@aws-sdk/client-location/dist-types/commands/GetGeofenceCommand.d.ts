...
declare const GetGeofenceCommand_base: {
    new (input: GetGeofenceCommandInput): import("@smithy/core/client").CommandImpl<GetGeofenceCommandInput, GetGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGeofenceCommandInput): import("@smithy/core/client").CommandImpl<GetGeofenceCommandInput, GetGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
