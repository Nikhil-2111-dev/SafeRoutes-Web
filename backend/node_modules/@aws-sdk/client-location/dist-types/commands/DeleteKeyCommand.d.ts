...
declare const DeleteKeyCommand_base: {
    new (input: DeleteKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyCommandInput, DeleteKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteKeyCommandInput, DeleteKeyCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
