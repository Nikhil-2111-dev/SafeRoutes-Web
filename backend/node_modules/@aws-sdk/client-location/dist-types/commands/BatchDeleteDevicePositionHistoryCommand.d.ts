...
declare const BatchDeleteDevicePositionHistoryCommand_base: {
    new (input: BatchDeleteDevicePositionHistoryCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteDevicePositionHistoryCommandInput, BatchDeleteDevicePositionHistoryCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDeleteDevicePositionHistoryCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteDevicePositionHistoryCommandInput, BatchDeleteDevicePositionHistoryCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
