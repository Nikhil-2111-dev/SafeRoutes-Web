...
declare const UpdatePlaceIndexCommand_base: {
    new (input: UpdatePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<UpdatePlaceIndexCommandInput, UpdatePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<UpdatePlaceIndexCommandInput, UpdatePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
