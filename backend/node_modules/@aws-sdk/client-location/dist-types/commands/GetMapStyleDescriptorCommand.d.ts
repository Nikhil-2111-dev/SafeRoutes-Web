...
declare const GetMapStyleDescriptorCommand_base: {
    new (input: GetMapStyleDescriptorCommandInput): import("@smithy/core/client").CommandImpl<GetMapStyleDescriptorCommandInput, GetMapStyleDescriptorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMapStyleDescriptorCommandInput): import("@smithy/core/client").CommandImpl<GetMapStyleDescriptorCommandInput, GetMapStyleDescriptorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
