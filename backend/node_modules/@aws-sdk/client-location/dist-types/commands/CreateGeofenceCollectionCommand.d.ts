...
declare const CreateGeofenceCollectionCommand_base: {
    new (input: CreateGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<CreateGeofenceCollectionCommandInput, CreateGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<CreateGeofenceCollectionCommandInput, CreateGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
