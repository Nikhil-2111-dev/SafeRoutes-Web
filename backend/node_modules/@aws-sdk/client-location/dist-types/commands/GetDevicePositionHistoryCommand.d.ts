...
declare const GetDevicePositionHistoryCommand_base: {
    new (input: GetDevicePositionHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetDevicePositionHistoryCommandInput, GetDevicePositionHistoryCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDevicePositionHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetDevicePositionHistoryCommandInput, GetDevicePositionHistoryCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
