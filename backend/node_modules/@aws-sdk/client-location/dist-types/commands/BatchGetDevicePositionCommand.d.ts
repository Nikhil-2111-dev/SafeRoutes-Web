...
declare const BatchGetDevicePositionCommand_base: {
    new (input: BatchGetDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<BatchGetDevicePositionCommandInput, BatchGetDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<BatchGetDevicePositionCommandInput, BatchGetDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
