...
declare const CalculateRouteMatrixCommand_base: {
    new (input: CalculateRouteMatrixCommandInput): import("@smithy/core/client").CommandImpl<CalculateRouteMatrixCommandInput, CalculateRouteMatrixCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CalculateRouteMatrixCommandInput): import("@smithy/core/client").CommandImpl<CalculateRouteMatrixCommandInput, CalculateRouteMatrixCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
