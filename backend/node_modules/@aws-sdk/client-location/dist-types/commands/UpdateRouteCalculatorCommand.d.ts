...
declare const UpdateRouteCalculatorCommand_base: {
    new (input: UpdateRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteCalculatorCommandInput, UpdateRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteCalculatorCommandInput, UpdateRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
