...
declare const DescribeRouteCalculatorCommand_base: {
    new (input: DescribeRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteCalculatorCommandInput, DescribeRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteCalculatorCommandInput, DescribeRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
