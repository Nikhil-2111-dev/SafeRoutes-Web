...
declare const ListGeofenceCollectionsCommand_base: {
    new (input: ListGeofenceCollectionsCommandInput): import("@smithy/core/client").CommandImpl<ListGeofenceCollectionsCommandInput, ListGeofenceCollectionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGeofenceCollectionsCommandInput]): import("@smithy/core/client").CommandImpl<ListGeofenceCollectionsCommandInput, ListGeofenceCollectionsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
