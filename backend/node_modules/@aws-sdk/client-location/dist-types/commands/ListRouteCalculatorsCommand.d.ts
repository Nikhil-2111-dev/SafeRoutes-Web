...
declare const ListRouteCalculatorsCommand_base: {
    new (input: ListRouteCalculatorsCommandInput): import("@smithy/core/client").CommandImpl<ListRouteCalculatorsCommandInput, ListRouteCalculatorsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRouteCalculatorsCommandInput]): import("@smithy/core/client").CommandImpl<ListRouteCalculatorsCommandInput, ListRouteCalculatorsCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
