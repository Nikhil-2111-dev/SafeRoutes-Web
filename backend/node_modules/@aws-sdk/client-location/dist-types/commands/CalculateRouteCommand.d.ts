...
declare const CalculateRouteCommand_base: {
    new (input: CalculateRouteCommandInput): import("@smithy/core/client").CommandImpl<CalculateRouteCommandInput, CalculateRouteCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CalculateRouteCommandInput): import("@smithy/core/client").CommandImpl<CalculateRouteCommandInput, CalculateRouteCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
