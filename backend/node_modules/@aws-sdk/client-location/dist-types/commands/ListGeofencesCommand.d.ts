...
declare const ListGeofencesCommand_base: {
    new (input: ListGeofencesCommandInput): import("@smithy/core/client").CommandImpl<ListGeofencesCommandInput, ListGeofencesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGeofencesCommandInput): import("@smithy/core/client").CommandImpl<ListGeofencesCommandInput, ListGeofencesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
