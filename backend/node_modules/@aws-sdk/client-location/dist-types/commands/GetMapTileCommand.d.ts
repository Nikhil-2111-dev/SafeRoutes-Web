...
declare const GetMapTileCommand_base: {
    new (input: GetMapTileCommandInput): import("@smithy/core/client").CommandImpl<GetMapTileCommandInput, GetMapTileCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMapTileCommandInput): import("@smithy/core/client").CommandImpl<GetMapTileCommandInput, GetMapTileCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
