...
declare const VerifyDevicePositionCommand_base: {
    new (input: VerifyDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<VerifyDevicePositionCommandInput, VerifyDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: VerifyDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<VerifyDevicePositionCommandInput, VerifyDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
