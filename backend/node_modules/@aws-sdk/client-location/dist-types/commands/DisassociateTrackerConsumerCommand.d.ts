...
declare const DisassociateTrackerConsumerCommand_base: {
    new (input: DisassociateTrackerConsumerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrackerConsumerCommandInput, DisassociateTrackerConsumerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTrackerConsumerCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrackerConsumerCommandInput, DisassociateTrackerConsumerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
