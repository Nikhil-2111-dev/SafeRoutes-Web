...
declare const DescribeGeofenceCollectionCommand_base: {
    new (input: DescribeGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeGeofenceCollectionCommandInput, DescribeGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeGeofenceCollectionCommandInput, DescribeGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
