...
declare const GetDevicePositionCommand_base: {
    new (input: GetDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<GetDevicePositionCommandInput, GetDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDevicePositionCommandInput): import("@smithy/core/client").CommandImpl<GetDevicePositionCommandInput, GetDevicePositionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
