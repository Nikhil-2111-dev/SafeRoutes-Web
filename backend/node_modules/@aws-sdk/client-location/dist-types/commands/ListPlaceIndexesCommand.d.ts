...
declare const ListPlaceIndexesCommand_base: {
    new (input: ListPlaceIndexesCommandInput): import("@smithy/core/client").CommandImpl<ListPlaceIndexesCommandInput, ListPlaceIndexesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPlaceIndexesCommandInput]): import("@smithy/core/client").CommandImpl<ListPlaceIndexesCommandInput, ListPlaceIndexesCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
