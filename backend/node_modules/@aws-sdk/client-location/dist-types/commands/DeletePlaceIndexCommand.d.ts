...
declare const DeletePlaceIndexCommand_base: {
    new (input: DeletePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<DeletePlaceIndexCommandInput, DeletePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePlaceIndexCommandInput): import("@smithy/core/client").CommandImpl<DeletePlaceIndexCommandInput, DeletePlaceIndexCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
