...
declare const DeleteMapCommand_base: {
    new (input: DeleteMapCommandInput): import("@smithy/core/client").CommandImpl<DeleteMapCommandInput, DeleteMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMapCommandInput): import("@smithy/core/client").CommandImpl<DeleteMapCommandInput, DeleteMapCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
