...
declare const DeleteGeofenceCollectionCommand_base: {
    new (input: DeleteGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteGeofenceCollectionCommandInput, DeleteGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteGeofenceCollectionCommandInput, DeleteGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
