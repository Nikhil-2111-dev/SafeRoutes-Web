...
declare const BatchPutGeofenceCommand_base: {
    new (input: BatchPutGeofenceCommandInput): import("@smithy/core/client").CommandImpl<BatchPutGeofenceCommandInput, BatchPutGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchPutGeofenceCommandInput): import("@smithy/core/client").CommandImpl<BatchPutGeofenceCommandInput, BatchPutGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
