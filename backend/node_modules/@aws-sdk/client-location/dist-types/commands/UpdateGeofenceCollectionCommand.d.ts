...
declare const UpdateGeofenceCollectionCommand_base: {
    new (input: UpdateGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateGeofenceCollectionCommandInput, UpdateGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateGeofenceCollectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateGeofenceCollectionCommandInput, UpdateGeofenceCollectionCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
