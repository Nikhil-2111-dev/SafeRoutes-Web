...
declare const PutGeofenceCommand_base: {
    new (input: PutGeofenceCommandInput): import("@smithy/core/client").CommandImpl<PutGeofenceCommandInput, PutGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutGeofenceCommandInput): import("@smithy/core/client").CommandImpl<PutGeofenceCommandInput, PutGeofenceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
