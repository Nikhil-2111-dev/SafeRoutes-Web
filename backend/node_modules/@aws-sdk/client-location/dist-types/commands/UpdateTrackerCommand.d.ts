...
declare const UpdateTrackerCommand_base: {
    new (input: UpdateTrackerCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrackerCommandInput, UpdateTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTrackerCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrackerCommandInput, UpdateTrackerCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
