...
declare const CreateRouteCalculatorCommand_base: {
    new (input: CreateRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCalculatorCommandInput, CreateRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteCalculatorCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCalculatorCommandInput, CreateRouteCalculatorCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
