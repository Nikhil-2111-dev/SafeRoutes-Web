...
declare const SearchPlaceIndexForTextCommand_base: {
    new (input: SearchPlaceIndexForTextCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForTextCommandInput, SearchPlaceIndexForTextCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchPlaceIndexForTextCommandInput): import("@smithy/core/client").CommandImpl<SearchPlaceIndexForTextCommandInput, SearchPlaceIndexForTextCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
