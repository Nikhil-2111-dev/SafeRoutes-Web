...
declare const GetPlaceCommand_base: {
    new (input: GetPlaceCommandInput): import("@smithy/core/client").CommandImpl<GetPlaceCommandInput, GetPlaceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPlaceCommandInput): import("@smithy/core/client").CommandImpl<GetPlaceCommandInput, GetPlaceCommandOutput, import("..").LocationClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
