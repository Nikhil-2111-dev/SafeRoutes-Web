    ...
    <ProtectedRoute>
      ...
      <div className="w-20 bg-[#121212] border-r border-white/5 flex flex-col items-center py-6 z-20 h-[calc(100vh-80px)]">
        <div className="flex flex-col space-y-8 flex-grow mt-4">
          <Link href="/dashboard" className="text-white hover:text-white transition bg-white/10 p-3 rounded-xl shadow-[0_0_15px_rgba(255,255,255,0.1)]"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M3 3h8v8H3zm10 0h8v8h-8zM3 13h8v8H3zm10 0h8v8h-8z"/></svg></Link>
