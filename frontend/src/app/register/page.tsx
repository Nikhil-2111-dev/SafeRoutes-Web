...
export default function RegisterPage() {
      ...
      await signUp({
        ...
        options: {
          userAttributes: {
            email,
            name,
            phone_number: mobile.startsWith('+') ? mobile : `+91${mobile}`,
            birthdate: dob,
            gender: gender,
            address: address
          }
  ...
  return (
    <main className="min-h-[calc(100dvh-4rem)] bg-black text-white relative overflow-hidden flex items-center justify-center p-4 py-10 font-sans select-none">
      ...
      <div className="w-full max-w-2xl bg-black border-2 border-white/10 rounded-[2rem] p-8 sm:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.85)] relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400">
            Join the community for a safer route home.
          </p>
        </div>
        ...
        <button
          type="button"
          className="w-full mb-8 flex items-center justify-center gap-3 bg-black hover:bg-zinc-900 border-2 border-white/20 text-white py-3.5 rounded-xl text-sm font-medium transition-all cursor-pointer"
        >
        ...
        <div className="flex items-center mb-8">
          ...
          <span className="mx-4 text-xs font-mono text-zinc-600 uppercase tracking-widest">Or Register Manually</span>
          <div className="flex-grow border-t border-zinc-800"></div>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input 
                ...
                required
                className="w-full bg-black border-2 border-white/20 focus:border-white text-white placeholder-zinc-500 px-4 py-3.5 rounded-xl text-sm transition-all outline-none [color-scheme:dark]"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <select 
                  ...
                  required
                  className="w-full bg-black border-2 border-white/20 focus:border-white text-white placeholder-zinc-500 px-4 py-3.5 rounded-xl text-sm transition-all outline-none appearance-none cursor-pointer"
                >
            ...
            <div>
              ...
              <input 
                ...
                placeholder="••••••••"
                required
                className="w-full bg-[#050505] border border-zinc-800 focus:border-white text-white placeholder-zinc-600 px-4 py-3.5 rounded-xl text-sm transition-all outline-none"
              />
            </div>
          </div>
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full py-4 mt-4 rounded-xl font-bold bg-[#00dfc0] hover:bg-[#00c9ad] text-slate-950 shadow-[0_0_15px_rgba(0,223,192,0.3)] hover:shadow-[0_0_25px_rgba(0,223,192,0.5)] transition-all disabled:opacity-50 text-sm tracking-wider uppercase flex items-center justify-center gap-2 cursor-pointer"
          >
